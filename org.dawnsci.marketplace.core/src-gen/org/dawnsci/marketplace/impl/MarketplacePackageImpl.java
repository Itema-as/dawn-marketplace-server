...
public class MarketplacePackageImpl extends EPackageImpl implements MarketplacePackage {
	 ...
	 * @generated
	 */
	public EAttribute getNode_RawBody() {
	 ...
	 * @generated
	 */
	public EAttribute getIu_Required() {
		return (EAttribute)iuEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EReference getMarketplace_Markets() {
	 ...
	 * @generated
	 */
	public EAttribute getMarketplace_BaseUrl() {
	 ...
	 * @generated
	 */
	public EReference getMarketplace_Search() {
	 ...
	 * @generated
	 */
	public EAttribute getSearch_Term() {
	 ...
	 * @generated
	 */
	public EAttribute getSearch_Url() {
	 ...
	 * @generated
	 */
	public EAttribute getSearch_Count() {
	 ...
	 * @generated
	 */
	public EReference getSearch_Nodes() {
	...
	public void createPackageContents() {
		...
		createEAttribute(iuEClass, IU__REQUIRED);
		...
		createEReference(marketplaceEClass, MARKETPLACE__MARKETS);
		...
		createEAttribute(searchEClass, SEARCH__TERM);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getTag_Id(), ecorePackage.getELongObject(), "id", null, 0, 1, Tag.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getIu_Selected(), ecorePackage.getEBoolean(), "selected", null, 0, 1, Iu.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getIu_Required(), ecorePackage.getEBoolean(), "required", null, 0, 1, Iu.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getMarketplace_Markets(), this.getMarket(), null, "markets", null, 0, -1, Marketplace.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getCatalog_Id(), ecorePackage.getELongObject(), "id", null, 0, 1, Catalog.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getMarket_Id(), ecorePackage.getELongObject(), "id", null, 0, 1, Market.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
